...
subito, causando una forte irritazione da parte dell'utente che si ritrova
...
all'utente perch\`e gli viene richiesto l'utilizzo dell'asse orizzontale per
ottenere l'informazione, oltre che ridurre lo spazio disponibile per il
contenuto esplicitamente richiesto da chi naviga. Sarebbe meglio ridurre il
numero di colonne, per rendere il sito pi\`u fruibile in generale.
...
Nella seconda colonna, troviamo una serie di articoli in primo piano. Questa
disposizione degli articoli in primo piano li porta però poco in risalto:
% TODO: rileggere sta parte
il come suggerito dalle impronte termografiche sulle zone di visibilità di un
sito web si è notato che il footer solitamente non rientra nella zona ``calda''
di visibilità degli utenti, e quindi questi articoli in primo piano non sono
messi in risalto per un utente che naviga nel sito.
Nella terza colonna troviamo gli ultimi commenti scritti dalla community sul
sito, anche se non è possibile vederne un'anteprima, ma solo l'articolo in cui
sono stati scritti. Questo causa all'utente un possibile
\textit{gambling click}, in caso voglia conoscere il contenuto del commento ma
non sappia dove venga portato al click del link.
