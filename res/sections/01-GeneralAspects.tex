...
% TODO: need to say something about the color of visited link?
...
Non sono presenti ``effetti speciali'' se non un piccolo effetto \textit{fade-in}
al caricamento di ogni pagina, che a mio avviso non compromette l'usabilità, ma
anzi l'aiuta in quando allieta l'attesa dell'utente mentre la pagina è in
caricamento.
