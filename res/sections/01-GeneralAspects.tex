...
Se si capita in una pagina inesistente del sito l'utente viene notificato
tramite la pagina 404, in cui viene segnalato il fatto che la pagina richiesta
non esiste e viene proposta una lista di pagine, categorie, tag e autori da cui
